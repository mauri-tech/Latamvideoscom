...
const DoubleCTA = () => {
  return (
    <section className="py-20 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-[#1D2E47] via-[#0050FF]/30 to-[#A0C4FF]/20 z-0">
      ...
      <div className="absolute top-0 left-1/4 w-64 h-64 rounded-full bg-[#007AFF]/10 mix-blend-overlay blur-3xl"></div>
      <div className="absolute bottom-0 right-1/4 w-96 h-96 rounded-full bg-[#A0C4FF]/10 mix-blend-overlay blur-3xl"></div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-8 text-white hover:bg-white/15 transition-colors flex flex-col items-center text-center">
            <div className="bg-[#007AFF]/20 p-4 rounded-full mb-6 backdrop-blur-sm">
            ...
            <Button 
              className="bg-white text-[#0050FF] hover:bg-white/90 mt-auto" 
              size="lg"
              asChild
            >
          ...
          <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-8 text-white hover:bg-white/15 transition-colors flex flex-col items-center text-center">
            ...
            <Button 
              variant="outline" 
              className="border-white text-white hover:bg-white/10 mt-auto" 
              size="lg"
              asChild
            >
